...
const ExperienceView = ({
  ...
  return (
    ...
    >
      <div className="mb-4 text-xl font-semibold text-[--pure-text] opacity-50 tracking-wider">
        From {resumePart} history
      </div>
      <h1 className="text-3xl font-bold uppercase text-[--pure-text]">
        {resume.event}
      </h1>
      <div className="mt-4 space-y-2 text-[--pure-text]">
      ...
      <span className="block mt-4 font-semibold text-[--pure-text]">
